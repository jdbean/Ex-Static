...
export default {
  ...
  output: {
    path: `${__dirname}/lib/ex-static/public`, // Note: Physical files are only output by the production build task `npm run build`.
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(woff|woff2)(\?.*$|$)/,
        loader: 'file-loader?prefix=font/&limit=30000',
      },
      {
        test: /\.ttf(\?v=\d+.\d+.\d+)?$/,
